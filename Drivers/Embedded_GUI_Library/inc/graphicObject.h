...
extern  uint8_t touch_done;           /*!< touchscreen event status */
//extern  uint8_t calibration_magic;     /*!< touchscreen calibration status */
extern  uint8_t joy_done;             /*!< joystick event status */
...
GL_PageControls_TypeDef* NewLabel (uint16_t ID, const uint8_t* label, GL_Direction direction,
	font_list_t Font,  uint32_t FontColour,  uint32_t BackgroundColour);
...
GL_ErrStatus Set_Label_Colour( GL_Page_TypeDef* pPage, uint16_t ID,
	 uint32_t FontColour,  uint32_t BackgroundColour);
...
/* Line handler **************************************************************/
GL_PageControls_TypeDef* NewLine (uint32_t ID,  uint32_t Len,
																	GL_Direction direction,  uint16_t Colour);
